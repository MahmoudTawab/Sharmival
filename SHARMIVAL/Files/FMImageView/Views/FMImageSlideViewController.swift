...
public class FMImageSlideViewController: UIViewController {
    ...
    private func setupTopSubView() {
        ...
        NSLayoutConstraint.activate(
            [NSLayoutConstraint(item: dismissButton ?? UIView(), attribute: .left, relatedBy: .equal, toItem: topView, attribute: .left, multiplier: 1, constant: Constants.Layout.leadingDismissButton)] +
                [NSLayoutConstraint(item: dismissButton ?? UIView(),attribute: .top, relatedBy: .equal, toItem: topView,attribute: .top, multiplier: 1, constant: Constants.Layout.cHeightTV / 2)] +
                [NSLayoutConstraint(item: numberImageLabel ?? UIView(),attribute: .centerX, relatedBy: .equal, toItem: topView, attribute: .centerX, multiplier: 1, constant: 0)] +
                [NSLayoutConstraint( item: numberImageLabel ?? UIView(), attribute: .top, relatedBy: .equal, toItem: topView, attribute: .top, multiplier: 1, constant: Constants.Layout.cHeightTV / 2)]
        )
