...
open class KRPullLoadView: UIView, KRPullLoadable {
    ...
    open func setUp() {
        ...
        activityIndicator.strokeColor = #colorLiteral(red: 0.9608150125, green: 0.7241352201, blue: 0.1713911593, alpha: 1)
        activityIndicator.translatesAutoresizingMaskIntoConstraints = false
        addSubview(activityIndicator)

        messageLabel.font = .systemFont(ofSize: ControlWidth(10))
        messageLabel.textAlignment = .center
        messageLabel.textColor = #colorLiteral(red: 0.9608150125, green: 0.7241352201, blue: 0.1713911593, alpha: 1)
