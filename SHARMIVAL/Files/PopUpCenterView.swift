...
class PopUpCenterView: UIViewController {
  ...
  func SetUp() {
    ...
    StackVertical.topAnchor.constraint(equalTo: Details.bottomAnchor, constant: ControlX(30)).isActive = true
  ...
  lazy var TitleLabel : UILabel = {
      ...
      Label.font = UIFont(name: "Poppins-Medium" ,size: ControlWidth(20))
      return Label
  }()
  ...
  lazy var Details : UITextView = {
      ...
      TV.font = UIFont(name: "Poppins-Regular" ,size: ControlWidth(14))
  ...
  lazy var LeftButton : UIButton = {
      ...
      Button.titleLabel?.font = UIFont(name: "Poppins-Medium", size: ControlWidth(15))
